            ...
            <div className="content-in-details">
                <div className="section second-color">
                    ...
                    <div className="description">
                        <p>
                            <IconText iconPath="ressources/icons/important.svg"
                             text="If you have selected a sprite, its color in the Hierarchy window will be blue." />

                            <IconText iconPath="ressources/icons/important.svg"
                             text="If you hovered over a sprite, its background color will be white-grey." />
                        </p>
                    </div>
                </div>
                <div className="section first-color">
                    <h5>Create</h5>
                    <div className="description">
                        <p>
                ...
                <div className="section first-color">
                    ...
                    <div className="description">
                        ...
                        <p>
                        <IconText iconPath="ressources/icons/important.svg"
                             text="If you delete a child, it will not delete the parent" />

                        <IconText iconPath="ressources/icons/important.svg"
                             text="Deleting a parent will delete all its children." />
                        </p>
